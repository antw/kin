module Showcase
  module Common
    ##
    # The Nav class is used when creating main navigation navs. Typically
    # this is the "Sets", "Search", "Your Account", etc nav, but is also used
    # for the sets subnav.
    #
    module Nav
      ...
      ##
      # Returns an instance of Nav which has already been configured,
      # identified by the given name.
      #
      # @param [Symbol] name
      #   The name of the nav to return. If no name is given, the default
      #   nav will be returned.
      # @return [Showcase::Nav]
      #
      ...
      class Menu
        ...
        ##
        # Creates a new nav. Expects a name to be given; if none is supplied,
        # it will be assumed you are setting up the default.
        #
      ...
      class Item
        ...
        ##
        # Returns true if this item expects a resource in order to generate
        # a URL.
        #
      ...
      module Helper
        ...
        # altering Merb::Plugins.config[:showcase_common][:nav_formatter].
        #
        ...
        def display_navigation(name, current, options = {})
          Merb::Plugins.config[:showcase_common][:nav_formatter].new(
            Showcase::Common::Nav.get(name), current, options
          ).to_html
        end
      end # Helper
